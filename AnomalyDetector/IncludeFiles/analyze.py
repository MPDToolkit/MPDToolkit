...
#        log_file = open(os.path.join(job_path, 'batch_log.txt'), 'a')
#        #Display time
#        log_file.write("Average elapsed time: {0:.3f} ms\n".format( total_time.get_time(1000) / len(img_list) ) )
#        log_file.write("Total elapsed time: {0:.3f} sec\n".format( total_time.get_time() ) )
#        log_file.write("{0} image(s) analyzed\n\n".format(len(img_list)))
#        log_file.flush()
